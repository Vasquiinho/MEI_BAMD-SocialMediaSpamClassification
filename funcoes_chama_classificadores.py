...
def classifica_sklearn_dtree(array_strings):
    array_resultado = []
    for frase in array_strings:
        array_resultado.append(modelo_arvore_decisao.predict_proba([frase]))

    return array_resultado

def classifica_sklearn_rlogistica(array_strings):
    array_resultado = []
    for frase in array_strings:
        array_resultado.append(modelo_arvore_decisao.predict_proba([frase]))
...
def classifica_sklearn_randomforest(array_strings):
    array_resultado = []
    for frase in array_strings:
        array_resultado.append(modelo_arvore_decisao.predict_proba([frase]))
...
def classifica_pytorch(array_strings):
    ...
    array_resultado = []
    for frase in array_strings:
        array_resultado.append(predict(model, frase))
